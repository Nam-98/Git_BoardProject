				...
				<div class="notice">
					...
					<div id=wrapper>
						<div class='row'>
							...
							<div class='input'>
								<input type="text" class="textSpace" required id="idmsg"
									name="id" placeholder="8-12글자의 알파벳 대소문자" value="${list[0].id }"
									readonly>
							</div>
						</div>
						<!-- 						<div class='row'> -->
						...
						<div class='row'>
							...
							<div class='input'>
								<input type="text" class="textSpace" required name="name"
									value="${list[0].name }" readonly>
							</div>
						</div>
						<div class='row'>
							<div class='index'>전화번호</div>
							<div class='input'>
								<input type="text" class="textSpace" placeholder="01012341234"
									name="contact" required value="${list[0].contact }" readonly>
							</div>
						...
						<div class='row' id=underBtn align=center>
							...
							<input type="button" id="quit_btn" value="탈퇴하기"> <input
								type="button" id="goHome_btn" value="홈으로 가기"> <br>
						</div>
